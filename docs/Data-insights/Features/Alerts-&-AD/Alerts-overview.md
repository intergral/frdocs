...
| **Contact Points** | Define the message content and the destination (e.g., Email, Slack, PagerDuty, or Webhooks) for your notifications. |
...
| **Silences** | Pauses notifications without stopping the rule evaluation. |
