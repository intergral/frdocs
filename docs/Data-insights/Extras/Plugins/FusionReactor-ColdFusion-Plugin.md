...
|Cached Query Count|9| The number of queries that are stored in cache. Requires cached query monitoring to be enabled either via [system property](../Configuration/FusionReactor-System-Properties.md) or [configuration.](#Configuration)                                                                                                                                                                                                                         |
...
|Query Cache Hit Ratio|21| The query cache hit ratio. Requires cached query monitoring to be enabled either via [system property](../Configuration/FusionReactor-System-Properties.md) or [configuration.](#Configuration)                                                                                                                                                                                                                                              |
|Query Cache Size (bytes)|22| The size of the cache. Requires cached query monitoring to be enabled either via [system property](../Configuration/FusionReactor-System-Properties.md) or [configuration.](#Configuration)                                                                                                                                                                                                                                                  |
...
-   [ColdFusion Metrics](../Metrics/ColdFusion-Metrics.md)
-   [ColdFusion System Metrics](../Metrics/ColdFusion-System-Metrics.md)
