...
Prevent log files shipping using a regex pattern in the [logging > cloud settings](/frdocs/Data-insights/Features/frdocs/Data-insights/Features/Logs/Cloud-Settings/#log-exclusion), using a similar mechanism to log scrape.
