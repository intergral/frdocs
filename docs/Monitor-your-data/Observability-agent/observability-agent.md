...
|--------------------------|----------|---------------------------------------------------------------|
| `api_key`           | `string` | API Key to authenticate with your FusionReactor Cloud Account. [Generate an API key](/Cloud/integrations/Metric-Integrations/#step-1-generate-an-api-key).              |
