...
!!! tip 
    This is a manual process so if you have over 100 servers,  we recommend manual activation or [scripting](/Best-Practices/Installation/scripted1/) to install FR.
<br>
